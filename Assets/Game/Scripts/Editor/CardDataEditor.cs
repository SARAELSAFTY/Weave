...
public class CardDataEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        // Demon Integration
        EditorGUILayout.LabelField("Demon Integration", EditorStyles.boldLabel);
        card.isDemonCard = EditorGUILayout.Toggle("Is Demon Card", card.isDemonCard);
        if (card.isDemonCard)
        {
            card.demonInitialTone = EditorGUILayout.TextField("Demon Initial Tone", card.demonInitialTone);
        }
