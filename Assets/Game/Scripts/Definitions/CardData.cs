...
public class CardData : ScriptableObject
{
    ...
    [Header("Demon Integration")]
    [Tooltip("Marks this card for demon interaction.")]
    public bool isDemonCard;
    [Tooltip("Tone for demon's first message (seductive, mocking, cryptic, threatening).")]
    public string demonInitialTone = "mocking";
